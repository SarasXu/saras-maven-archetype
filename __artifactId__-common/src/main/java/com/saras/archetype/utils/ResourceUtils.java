...
public abstract class ResourceUtils {
     ...
     *                     对象。
     * @param aggregate    如果该参数为 true ，则会在找到资源后继续往更低级别找，并将找到的资源 {@link URL}
     *                     加入返回结果中。
    ...
    // Set<Class<?>> classSet = getClassByFilePath(getResource("cn/agrael",
    // ResourceUtils.class).getFile());
    // long end = System.currentTimeMillis();
    // for (Class<?> clazz : classSet) {
    // System.out.println(clazz);
    // }
    //
    // String jarPath = "D:\\javaee\\AgraelAPI\\";
    // System.out.println(jarPath);
    // buildClassSetByJarPath(jarPath, classSet);
