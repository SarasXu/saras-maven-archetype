...
public class Reflections {
        ...
        for (String propertyName : propertyNames) {
            ...
            if (StringUtils.contains(propertyName, ".")) {
                ...
                for (String propertyNamePath : propertyNamePaths) {
                    ...
                    temp = invokeGetter(temp, propertyNamePath);
                }
                propertyValue = temp;
            } else {
                propertyValue = invokeGetter(obj, propertyName);
            }
    ...
    public static Set<String> getFieldNames(Class<?> pojoClass) {
        ...
        } while (clazz != null && !"Object".equalsIgnoreCase(clazz.getSimpleName()));
    ...
    private static void constructorSetAccessible(Constructor<?> constructor) {
