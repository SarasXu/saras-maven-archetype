...
public class ServletUtils {
    ...
    public static void writeResponse(HttpServletResponse response, String data) {
        ...
        try {
            ...
            throw new RuntimeException("响应请求(flushResponse)失败:"
                    + e.getMessage());
        } finally {
    ...
    public static String getRequestPath(HttpServletRequest request) {
        return StringUtils.substringAfter(request.getRequestURI(),
    ...
    public static List<String> getHeaderValues(HttpServletRequest request,
                                               String name) {
        ...
        while (names.hasMoreElements()) {
            ...
            if (StringUtils.isNotBlank(prefixName)) {
                if (StringUtils.startsWithIgnoreCase(name, prefixName)) {
                    map.put(StringUtils.lowerCase(name),
